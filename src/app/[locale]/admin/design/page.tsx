...
// SCOPE(admin): placeholder until the design module lands in this build. GROWS LATER → full module.
...
async function Content({ locale }: { locale: string }) {
  await requireAdminPage(locale, "store.design");
