...
export function AnnouncementBarBold({ text }: AnnouncementBarProps) {
  ...
  return (
    <div
      ...
      aria-label={text}
      dir="ltr"
      className="group overflow-hidden bg-inverse py-2 text-micro font-bold tracking-widest text-inverse-foreground uppercase [mask-image:linear-gradient(to_right,transparent,black_5%,black_95%,transparent)]"
    >
