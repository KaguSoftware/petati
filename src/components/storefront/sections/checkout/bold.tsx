    ...
    <main className="py-10 @tablet:py-14">
      <div className="bg-inverse text-inverse-foreground">
        <div className="mx-auto grid max-w-6xl gap-6 px-gutter py-8 @tablet:grid-cols-[auto_1fr] @tablet:items-start @tablet:gap-12 @tablet:py-10">
          ...
          <div className="text-inverse-foreground [&_*]:border-inverse-foreground/20 [&_.text-muted-foreground]:text-inverse-foreground/70 [&_h2]:text-inverse-foreground">{summary}</div>
        </div>
      </div>
