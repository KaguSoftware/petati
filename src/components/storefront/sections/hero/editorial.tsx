...
export function HeroEditorial({ title, subtitle, ctaLabel, ctaHref, imageUrl }: HeroProps) {
  return (
    <section className="mx-auto grid max-w-7xl items-end gap-10 px-4 py-16 @tablet:grid-cols-12 @tablet:gap-12 @tablet:py-24">
      <div className="flex flex-col gap-6 @tablet:col-span-5">
        ...
        <h1 className="font-serif text-4xl font-medium tracking-tight text-balance @tablet:text-5xl @desktop:text-6xl">{title}</h1>
      ...
      <figure className="flex flex-col gap-3 @tablet:col-span-7">
